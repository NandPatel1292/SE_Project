          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="mt-2">
                  ...
                  <div className="text-sm  my-2">
                    <a
                      href="#"
                      className="font-semibold text-red-300 hover:text-red-500"
                    >
                      Forgot password?
                    </a>
                  </div>
              ...
              <div>
                <button
                  type="submit"
                  className="flex w-full justify-center rounded-md bg-blue-200 text-black px-3 py-1.5 text-sm font-bold leading-6 shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
                >
                  Log in
                </button>
              </div>
