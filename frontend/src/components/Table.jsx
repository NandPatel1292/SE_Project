    ...
    <div className="relative overflow-x-auto shadow-md sm:rounded-lg my-4 mx-4 ">
      <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead className="  text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
          <tr>
            <th scope="col" className="p-4 bg-[#FFE2E291]">
            ...
            {tableHeaders && tableHeaders.length
              ? tableHeaders.map((header, index) => {
                  return (
                    <th scope="col" className="px-6 py-3 bg-[#FFE2E291]">
                      {header}
                    </th>
                  );
                })
        ...
        <tbody>
          {tableBodyDate && tableBodyDate.length
            ? tableBodyDate.map((item, index) => {
                return (
                  <tr className="bg-[#FFE2E291]  border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
